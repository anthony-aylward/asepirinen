...
#> [[1]]
#> [1] 2.995732 4.605170 4.499810
#> 
#> [[2]]
#> [1] 2.302585 2.995732
#> 
#> [[3]]
#> [1] 3.401197 4.787492 4.499810
#> 
#> numeric(0)
#> [1] -1.386294
#> Error in gtm.het(y, prob, pr.beta, pr.intv, two.sided, independent, log.prior): length(log.prior) %in% c(1 + nt - ceiling(nt/3), 1 + floor(nt/2)) is not TRUE
